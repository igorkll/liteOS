...
function env.createEnv(localEnv) --создает env для программы, где _G это будут глобалы а _ENV будет личная таблица окружения
...
return setmetatable(_ENV, {__index = function(tbl, key)
